    ...
    <div class="flex flex-1 h-full overflow-hidden">
        ...
        <aside id="sidebar"
            ...
            <nav class="flex-1 px-2 pt-4 flex flex-col gap-1 overflow-y-auto">
                ...
                <div class="text-[10px] font-semibold text-white/40 tracking-widest uppercase px-2.5 pb-1 mt-1">Utama
                </div>
                ...
                <div class="text-[10px] font-semibold text-white/40 tracking-widest uppercase px-2.5 pb-1 mt-4">Laporan
                </div>
                ...
                <a href="{{ url('/notifications') }}"
                    ...
                    Notifikasi
                    <span
                        class="ml-auto bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full leading-none">3</span>
                </a>
